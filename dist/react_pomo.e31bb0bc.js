...
var time = 0; //Fonction de remise a zero du counter
...
function tf_time(time) {
  var heure = Math.trunc(time / 1000 / 60 / 60);
  var min = Math.trunc((time - heure * 1000 * 60 * 60) / 1000 / 60);
  var sec = Math.trunc((time - heure * 1000 * 60 * 60 - min * 1000 * 60) / 1000);
...
document.getElementById("start").addEventListener("click", function () {
  var t_hour = document.getElementById("hour").value;
  var t_min = document.getElementById("min").value;
  var t_sec = document.getElementById("sec").value;
  var r_sec = t_sec * 1000;
  var r_min = t_min * 60 * 1000;
  var r_hour = t_hour * 60 * 60 * 1000;
  var r_total = r_sec + r_min + r_hour;
  console.log(r_sec);
  console.log(r_min);
  console.log(r_hour);
  console.log(r_total);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "40527" + '/');
...
//# sourceMappingURL=/react_pomo.e31bb0bc.js.map